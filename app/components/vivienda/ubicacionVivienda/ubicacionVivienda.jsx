...
export default function UbicacionVivienda({ barrios }) {
  ...
  const onSubmit = handleSubmit(async (data) => {
    const resul = await insertUbicacionVivienda(
      data,
  ...
  return (
    <div className="container-fluid">
      <ModalFinalizar
        ...
        tittle={`A Finalizado el registro de la vivienda de: ${session?.user?.email?.nombre} como ${session?.user?.email?.parentesco}`}
      >
