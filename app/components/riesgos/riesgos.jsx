    ...
    <form onSubmit={onSubmit}>
      ...
      <div className="row mb-3">
        <div className="col-sm-12 col-md-6 col-lg-4 col-xl-4">
          <label className="form-label"><h5>Grupo dispensarial</h5></label>
          <select
        ...
        <div className="col-sm-12 col-md-6 col-lg-4 col-xl-4">
          <label className="form-label"><h5>Grado Discapacidad</h5></label>
          <select
        ...
        <div className="col-sm-12 col-md-6 col-lg-4 col-xl-4">
          <label className="form-label"><h5>Porcentaje de discapacidad</h5></label>
          <input
            {...register("porcentaje", {
              required: {
                value: true,
      ...
      <div className="row mb-3">
        <div className="col-sm-12 col-xl-6">
        <label className="form-label"><h5>Seleccione el riesgo:</h5></label>
