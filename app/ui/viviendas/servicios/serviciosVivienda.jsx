...
export default function ServicioVivienda({ viviendaById }) {
  ...
  const onSubmit = handleSubmit(async (data) => {
    const resul = await insertViviendaServicio(data, params.id);
    if (resul.error) {
            ...
            <div className="d-flex">
              <select
                {...register("tratamientoAgua", {
                  ...
                  value: viviendaById.tratamientoagua,
            ...
            <div className="d-flex">
              <select
                {...register("tipoServicioHigienico", {
                  ...
                  value: viviendaById.servicio_higienico,
                  validate: (value) => value !== "",
                })}
                className="form-select"
                aria-label="Default select example"
            ...
            <div className="d-flex">
              <select
                {...register("servicioHigienico", {
                  ...
                  value: viviendaById.ubicacionsh,
                  validate: (value) => value !== "",
                })}
                className="form-select"
                aria-label="Default select example"
            ...
            <div className="d-flex">
              <select
                {...register("internet", {
                  ...
                  value: viviendaById.servicio_internet,
                  validate: (value) => value !== "",
                })}
                className="form-select"
                aria-label="Default select example"
